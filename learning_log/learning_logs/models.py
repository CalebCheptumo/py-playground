...
class Topic(models.Model): # created a class called Topic that inherits from Model a parent class included in django that defines a model basic functionality.
